...
class _EditProfileScreenState extends State<EditProfileScreen> {
  // Colors (same as AccountScreen style)
  static const Color textPink = Color(0xFFF82A87);
  static const Color accentPurple = Color(0xFF9B4BFF);

  final TextEditingController _nameController =
  TextEditingController(text: "JESSICA JOHNSON");
  final TextEditingController _usernameController =
  TextEditingController(text: "JESSICAJOJO24");
  ...
  Widget _buildTextField({
    ...
    return Container(
      ...
      child: Row(
        children: [
          Icon(icon, color: textPink.withOpacity(0.5)),
          ...
          InkWell(
            onTap: () {},
            child: Icon(Icons.edit, size: 18, color: textPink.withOpacity(0.5)),
          ),
        ],
      ),
    );
            ...
            children: [
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: SizedBox(
                    // make the pink box stretch down
