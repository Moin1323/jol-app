    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Divider(color: Colors.white.withOpacity(0.5), thickness: 1, height: 20),
          Row(
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _walletCard(),
                      const SizedBox(height: 16),
                      _menuRow("Refer & Earn", () => _showSnack("Refer tapped")),
                      _menuRow("Daily Check-in & Get Points",
                              () => _showSnack("Daily check-in tapped")),
                      _menuRow("Remove Ads", () => _showSnack("Remove Ads tapped")),
                      const SizedBox(height: 16),
                      _giftButton(),
                      const SizedBox(height: 16),
                    ],
